...
if exist "%TsrcPath%" (
	if exist "%TdestPath%" (
		call "%TinstPath%\7z\7za" a %TcompType% %TcompLvl% OfficeTools_%today%_%TrndmStrg%.%TcompExt% "%TsrcPath%\*" -p%TtempPass%
		...
		echo Key File					: OfficeTools_%TrndmStrg%_KEY.ofk >> "log/advlog"
